...
function SignInContent({ onLogin, onSwitchToSignUp }) {
  ...
  return (
    <>
      <Title bgColor={theme.modalBg}>Iniciar Sesión</Title>
      ...
      <LinkText accentColor={theme.accent} bgColor={theme.modalBg}>
        ¿No tienes cuenta? <a onClick={onSwitchToSignUp}>Regístrate aquí</a>
      </LinkText>
    </>
  );
}
